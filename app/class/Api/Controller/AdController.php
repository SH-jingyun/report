...
//	Banner:banner
        ...
        $sql = 'SELECT position_id, ad_source, ad_source_code, position_type, 10000 strategy_id FROM ad_position LEFT JOIN ad_strategy USING(position_id) LEFT JOIN ad_position_type USING(position_type_id) LEFT JOIN ad_ad_code USING(strategy_id) WHERE app_id = 10003 AND group_id = 1';
